    ...
    return (
        <div className='context-menu'>
            ...
            {kind === "instructor"  &&  <>
                ...
                {announcementSuccess && <><div className='success-box'>{announcementSuccess}</div><br/></>}
                {announcementError && <><div className='error-box'>{announcementError}</div><br/></>}
                
                <h2 className='color-gray' style={{textAlign: "center", margin: "1rem 0"}}>Create a new announcement</h2>
                <hr/>
                <form style={{display:"flex", flexDirection: "column", gap: '10px'}} onSubmit={(e) => createAnnouncement(e)}>
                    <label for="announcement_title">Title:</label>
                    <input style={{fontFamily: "Lisu Bosa", backgroundColor: "#FFF", fontSize: "22px", padding: "10px 5px", border: 'none', borderBottom: "1px solid #000", outline: 'none'}} type="text" id="announcement_title" onChange={(e) => setAnnouncementTitle(e.target.value)} value={announcementTitle}></input>

                    <label for="announcement_content">Description:</label>
                    <textarea style={{fontFamily: "Lisu Bosa", backgroundColor: "#FFF", fontSize: "22px", padding: "10px 5px", border: 'none', borderBottom: "1px solid #000", outline: 'none'}} id="announcement_content" onChange={(e) => setAnnouncementDescription(e.target.value)} value={announcementDescription}></textarea>

                    <button type="submit" className='blue-btn'>Create</button>
                </form>
            </>}
